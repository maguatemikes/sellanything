...
export type CollectionMetaQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CollectionMetaQuery = {
...
export type CollectionFallbackSearchQueryVariables = StorefrontAPI.Exact<{
...
export type CollectionFallbackSearchQuery = {
  search: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
...
export type ShopFilteredQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  first: StorefrontAPI.Scalars['Int']['input'];
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CollectionMeta(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      handle\n      title\n      description\n      image { url altText width height }\n    }\n  }\n': {
    return: CollectionMetaQuery;
    variables: CollectionMetaQueryVariables;
  };
  ...
  '#graphql\n  #graphql\n  fragment MoneyProductItem on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment ProductItem on Product {\n    id\n    handle\n    title\n    vendor\n    productType\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice { ...MoneyProductItem }\n      maxVariantPrice { ...MoneyProductItem }\n    }\n  }\n\n  query CollectionFallbackSearch(\n    $query: String!\n    $first: Int!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    search(query: $query, types: PRODUCT, first: $first) {\n      nodes {\n        ... on Product { ...ProductItem }\n      }\n    }\n  }\n': {
    return: CollectionFallbackSearchQuery;
    variables: CollectionFallbackSearchQueryVariables;
  };
  ...
  '#graphql\n  #graphql\n  fragment ProductTile on Product {\n    id\n    title\n    handle\n    vendor\n    productType\n    priceRange {\n      minVariantPrice { amount currencyCode }\n    }\n    featuredImage { id url altText width height }\n  }\n\n  query ShopFiltered($country: CountryCode, $language: LanguageCode, $first: Int!, $filters: [ProductFilter!], $sortKey: SearchSortKeys, $reverse: Boolean)\n    @inContext(country: $country, language: $language) {\n    search(query: "*", types: PRODUCT, productFilters: $filters, first: $first, sortKey: $sortKey, reverse: $reverse) {\n      nodes { ... on Product { ...ProductTile } }\n    }\n  }\n': {
    return: ShopFilteredQuery;
    variables: ShopFilteredQueryVariables;
  };
}
